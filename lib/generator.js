...
- Required entrypoints: \`manifest.json\`, \`agent.yaml\`, \`system-prompt.md\`, \`tools.json\`
...
6. Keep the relative subfolders intact: \`prompts/\`, \`evals/\`, \`memory/\`, \`setup/\`, \`context/\`, \`runtime/\`, and \`scripts/\`.
...
2. Keep \`agent-package.json\`, \`manifest.json\`, \`agent.yaml\`, \`setup/\`, \`context/\`, \`evals/\`, \`memory/\`, and \`prompts/\` together.
3. ${envLine}
4. ${modelLine}
5. ${vectorLine}
...
1. Load \`manifest.json\`, \`tools.json\`, \`system-prompt.md\`, and \`context/input-contract.md\`.
